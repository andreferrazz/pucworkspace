...
int main() {
    ...
    int min = animals[0].max_weight;
    int max = animals[0].max_weight;
    int avg = 0;
    for (int i = 0; i < size; i++) {
        if (animals[i].max_weight < min) {
            min = animals[i].max_weight;
        } 
        
        if (animals[i].max_weight > max) {
            max = animals[i].max_weight;
        } 

        avg += animals[i].max_weight;
    }
